...
class DataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        full_r = matLabel['real']
        full_i = matLabel['imag']
        ...
        linewidth = 5 + 10 * torch.rand(1)   ## random line-width, 5-10 Hz.
        LW_kernels = DecayingTerm(ksp_coords, linewidth, delta_T=self.delta_T)
        image = image * LW_kernels
        image_r = image.real
        image_i = image.imag


        return image_r, image_i, mask, label_r, label_i, linewidth
