...
# b subsampled time domian data; b = mask .* img_full;
...
class MRSNet(torch.nn.Module):
    ...
    def forward(self, b_r, b_i, mask, linewidth, delta_T=1/3648.800, device='cuda:0'):
        """
        ...
        LW_kernels = LW_kernels.to(device)
        mask = mask.to(device)
